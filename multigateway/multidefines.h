...
#define MAX_MULTISIG_OUTPUTS 4
#define MAX_MULTISIG_INPUTS 16
...
#define BTC_FIRST_BLOCKHEIGHT 296000
...
// multigateway protocol funcids
#define MULTIGATEWAY_SYNCWITHDRAW 0
#define MULTIGATEWAY_GETCOINADDR 1
#define MULTIGATEWAY_GETPUBKEY 2
